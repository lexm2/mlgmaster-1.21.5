...
public class PlayerRotationManager {
    ...
    public static void storeOriginalRotation(ClientPlayerEntity player) {
        if (!rotationStored) {
            ...
            rotationStored = true;
            MLGMaster.LOGGER.info("Stored original rotation: Yaw={} | Pitch={}", originalYaw, originalPitch);
        }
    }
    ...
    public static void setLookDown(ClientPlayerEntity player) {
        ...
        MLGMaster.LOGGER.info("Player rotation set to look down: Yaw={} | Pitch={}", player.getYaw(), player.getPitch());
    }
    ...
    public static void restoreOriginalRotation(ClientPlayerEntity player) {
        if (rotationStored) {
            ...
            MLGMaster.LOGGER.info("Restored original rotation: Yaw={} | Pitch={}", originalYaw, originalPitch);
        }
    }
