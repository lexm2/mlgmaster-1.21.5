...
/**
 * Manages automatic crouching/sneaking behavior for scaffolding operations.
 * This class actively controls the player's sneak state during scaffolding.
 */
public class ScaffoldingCrouchManager {
    ...
    /**
     * Activates scaffolding crouch mode for the given player.
     * Actually makes the player crouch by manipulating the sneak key state.
     * 
     * @param player the client player entity
     * @param minecraftClient the minecraft client instance
     */
    public static void activateScaffoldingCrouch(ClientPlayerEntity player, MinecraftClient minecraftClient) {
        ...
        if (!isScaffoldingCrouchActive) {
            ...
            MLGMaster.LOGGER.debug("Activated scaffolding crouch (was already sneaking: {})", wasAlreadySneaking);
        }
    }
     ...
     */
    public static void activateScaffoldingCrouchDirect(ClientPlayerEntity player, MinecraftClient minecraftClient) {
        if (player == null || minecraftClient == null) {
            return;
        }
        ...
        if (!isScaffoldingCrouchActive) {
            ...
            isScaffoldingCrouchActive = true;
            MLGMaster.LOGGER.debug("Activated scaffolding crouch direct (was already sneaking: {})", wasAlreadySneaking);
        }
    }

    /**
     * Releases scaffolding crouch mode.
     * Actually stops the player from crouching if they weren't already sneaking.
     */
    ...
    /**
     * Forces an immediate release of crouch mode.
     * Used for emergency cleanup when normal release logic shouldn't apply.
     */
    ...
    /**
     * Maintains the crouch state during tick updates.
     * Call this every tick to ensure the crouch remains active.
     */
     ...
     * Useful for cleanup when switching worlds or disconnecting.
     */
